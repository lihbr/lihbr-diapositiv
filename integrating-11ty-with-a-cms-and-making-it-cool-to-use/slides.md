...
<strong class="ml-6 block">agency client</strong>
...
<strong class="ml-6 block">write blog posts in a notebook, and then send pictures of it to a service</strong>
...
<strong class="ml-6 block">the content of my website gets updated</strong>
...
- <twemoji-page-facing-up /> A plugin can be nothing more than an 11ty configuration file
...
<twemoji-books class="inline mb-2" /> &nbsp;Everything from this talk, the Prismic plugin & more:
